...
function* exec() {
    ...
    const downloadedData = yield download("https://tanya-resume-web-page-two.vercel.app/");
    console.log("Data downloaded is", downloadedData);

    const fileResponse = yield writeFile(downloadedData, "example.txt");
    console.log("File write status", fileResponse);

    const uploadStatus = yield upload("example.txt", "https://tanya-resume-web-page-two.vercel.app/");
    console.log("Upload status", uploadStatus);

    const d2 = yield download("https://tanya-resume-web-page-two.vercel.app/");
    console.log("Data downloaded is", d2);
    
    const f2 = yield writeFile(d2, "example2.txt");
    console.log("File write status", f2);

    const uploadStatus2 = yield upload("https://tanya-resume-web-page-two.vercel.app/");
